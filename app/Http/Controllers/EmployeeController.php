...
class EmployeeController extends Controller
{
    ...
    {
        $this->middleware('permission:ver-employee|crear-employee|editar-employee|borrar-employee', ['only' => ['index']]);
        $this->middleware('permission:crear-employee', ['only' => ['create', 'store']]);
        $this->middleware('permission:editar-employee', ['only' => ['edit', 'update']]);
        $this->middleware('permission:borrar-employee', ['only' => ['destroy']]);
    }
